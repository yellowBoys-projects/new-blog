...
export default function Popular() {
	return (
		...
		<div className="border border-black p-5 flex gap-5 justify-around  ">
			<BigCard img={Img} alt="technology" trend="technology" date="january 01,2025" title="est stet amet ipsum stet clita rebum duo" para="Rebum dolore duo et vero ipsum clita, est ea sed duo diam ipsum, clita at justo, lorem amet vero eos sed sit"/>
			<BigCard img={Img} alt="technology" trend="technology" date="january 01,2025" title="est stet amet ipsum stet clita rebum duo" para="Rebum dolore duo et vero ipsum clita, est ea sed duo diam ipsum, clita at justo, lorem amet vero eos sed sit"/>
